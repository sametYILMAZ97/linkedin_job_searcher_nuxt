...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Generate optimized LinkedIn job search URLs with advanced filtering options. Find your perfect job faster with our professional URL builder tool.'
    },
    {
      name: 'keywords',
